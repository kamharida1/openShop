...
function Page() {
  ...
  const renderItem = ({ item }: any) => (
    <LinkButton title={item.title} link={item.link} style={item.style} />
  );
  ...
  const renderHeader = () => (
    <View style={tw`items-center`}>
      ...
      <Text style={tw`text-3xl font-bold text-center text-neutral-900`}>
        Hello World
      </Text>
      <Text style={tw`text-xl font-medium text-center text-neutral-400 `}>
